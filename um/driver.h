...
namespace t1drv {
	...
	bool Init() {
		DriverHandle = CreateFileW((L"\\\\.\\\{sdfjkn4e78hhsjk-sdfjnas78adasd}"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL);
	...
	void ReadPhysical(PVOID address, PVOID buffer, DWORD size) {
		...
		DeviceIoControl(DriverHandle, PaysonRead, &arguments, sizeof(arguments), nullptr, NULL, NULL, NULL);
	}
	...
	uintptr_t GetBaseAddress() {
		...
		DeviceIoControl(DriverHandle, PaysonBase, &arguments, sizeof(arguments), nullptr, NULL, NULL, NULL);
